...
<main>
	...
	<div class="recent">
			...
			<button class="btn-download" on:click={show}><span class="material-symbols-outlined">add</span></button><br><br>
			...
			<table>
					...
					<tbody>
						...
						<tr>
								...
								<td>{d.keterangan}</td>
								<td>
									<button on:click={()=>{edId = d;edShow()}}><span class="material-symbols-outlined">edit</span></button>
									<button on:click={()=>{delId = d.nim;delShow();}}><span class="material-symbols-outlined">delete</span></button>
								</td>
						</tr>
						{/each}
					</tbody>
